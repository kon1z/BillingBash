...
namespace Kon.IdentityService.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("IdentityService") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "IdentityService", DisplayName = "IdentityService API", Resources = { "IdentityService" }
            });
        }
    }
