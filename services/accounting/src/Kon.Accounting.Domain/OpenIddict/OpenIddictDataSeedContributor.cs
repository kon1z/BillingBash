...
namespace Kon.Accounting.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("Accounting") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "Accounting", DisplayName = "Accounting API", Resources = { "Accounting" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var blazorServerTieredClientId = configurationSection["Accounting_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["Accounting_BlazorServerTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["Accounting_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
