...
public class AccountingServiceDbContext :
    AbpDbContext<AccountingServiceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AccountingServiceConsts.DbTablePrefix + "YourEntities", AccountingServiceConsts.DbSchema);
