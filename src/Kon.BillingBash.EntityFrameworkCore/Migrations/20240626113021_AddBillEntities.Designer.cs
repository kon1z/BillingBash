...
namespace Kon.BillingBash.Migrations
{
    ...
    [Migration("20240626113021_AddBillEntities")]
    partial class AddBillEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kon.BillingBash.Domain.Entities.Bill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kon.BillingBash.Domain.Entities.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppItem", (string)null);
                });

            modelBuilder.Entity("Kon.BillingBash.Domain.Entities.PayItemHistory", b =>
                {
                    ...
                    b.ToTable("AppPayItemHistory", (string)null);
                });
            ...
            modelBuilder.Entity("Kon.BillingBash.Domain.Entities.Item", b =>
                {
                    b.HasOne("Kon.BillingBash.Domain.Entities.Bill", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Kon.BillingBash.Domain.Entities.PayItemHistory", b =>
                {
                    b.HasOne("Kon.BillingBash.Domain.Entities.Item", null)
                        .WithMany("PayItemHistories")
